...
<title>My Closed Auctions</title>
...
<div class="Col">
	<body> 
		...
		<center>
			<c2 align="center">My Closed Auctions:</c2>
			<p>
			...
			<table border="2" width="80%" cellpadding="5">
				...
				<%
					...
					query = "SELECT * FROM auctions2 WHERE Bidders_usrname='" + usrn + "'";
					...
					while (rs.next()) {
						...
						"<td><sel><center>%s</center></sel></td>" +
						"<td align='center'><form method='post' action='admin/picdisplay.jsp'><input type='hidden' name='id2' value='%s'><input type=submit class='btn btn-primary btn-block btn-large' value='Picture' ></form></td>" +
