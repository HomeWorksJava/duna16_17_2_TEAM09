...
<div class="Col">
	<body> 
		...
		<center>
		<c2 align="center">Search result:</c2>
			<p>
			...
			<table border="2" width="80%" cellpadding="5">
				...
				<%
					...
					categories = request.getParameter("searchcategories");
					
					
					if (search == null) {
						query = "SELECT * FROM auctions WHERE Categories='" + categories + "'";
					} else {
						if (categories == "") 
						{
						query = "SELECT * FROM auctions WHERE Item_name LIKE '" + "%" + search + "%" + "'";	
						}else{
						query = "SELECT * FROM auctions WHERE Item_name LIKE '" + "%" + search + "%" + "' and Categories='" + categories + "'";
						}
					}
